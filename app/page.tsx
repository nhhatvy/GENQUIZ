...
import {
  ...
  Trophy, Star, ShieldCheck, Check, X, Mail, MapPin, Phone,
  Sparkles,
  Newspaper,
  Atom,
  Dna,
...
export default function LandingPage() {
  const categories = [
    ...
    },
    {
      ...
      icon: <Dna size={22} />,
      color: "#ec4899", // Pink
      lightColor: "bg-pink-500/10 text-pink-400"
    },
    {
  ...
  return (
    ...
    `,
        ...
        <div className="relative z-5 max-w-8xl mx-auto space-y-7">
          ...
          <div className="pt-1">
            <button className="bg-gradient-to-r cursor-pointer from-[#5813C1] to-[#C45037] text-white px-7 py-3.5 rounded-2xl text-l font-bold shadow-[0_0_20px_rgba(88,19,193,0.3)] hover:scale-105 transition-all active:scale-95">
              Get started
            </button>
          </div>
