  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        {stats.map((stat) => (
          <div key={stat.label} className="rounded-sm border border-border bg-card p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        {/* Recent Events */}
        <div className="xl:col-span-2 rounded-sm border border-border bg-card p-6 space-y-4 shadow-sm">
        ...
        {/* Top Students */}
        <div className="rounded-sm border border-border bg-card p-6 space-y-4 shadow-sm">
          <div>
