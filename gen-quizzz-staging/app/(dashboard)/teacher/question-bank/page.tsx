    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-xl p-4 space-y-1">
          <p className="text-xs text-muted-foreground uppercase font-bold tracking-widest">Total Banks</p>
          <p className="text-2xl font-black text-white">{banks.length}</p>
        </div>
        <div className="bg-card border border-border rounded-xl p-4 space-y-1">
          <p className="text-xs text-muted-foreground uppercase font-bold tracking-widest">Total Questions</p>
          <p className="text-2xl font-black text-white">
            {banks.reduce((sum, b) => sum + b._count.questions, 0)}
          </p>
        </div>
        <div className="bg-card border border-border rounded-xl p-4 space-y-1">
          <p className="text-xs text-muted-foreground uppercase font-bold tracking-widest">From Files</p>
          <p className="text-2xl font-black text-white">
